...
public class ImageShowPickerView extends FrameLayout {
    ...
    private void viewTypedArray(Context context, AttributeSet attrs) {
        ...
        mAddLabel = typedArray.getResourceId(R.styleable.ImageShowPickerView_add_label, R.mipmap.image_show_picker_add);// 自定义add icon
        mDelLabel = typedArray.getResourceId(R.styleable.ImageShowPickerView_del_label, R.mipmap.image_show_picker_del); //自定义 delete icon
