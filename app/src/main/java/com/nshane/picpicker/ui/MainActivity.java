package com.nshane.picpicker.ui;
...
import com.nshane.picpicker.adapters.MyAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private List<List<ImageBean>> mDataList = new ArrayList<>();
    ...
    private void initView() {
        lv_con = (ListView) findViewById(R.id.lv_container);
    }
